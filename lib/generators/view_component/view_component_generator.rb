...
class ViewComponentGenerator < Rails::Generators::NamedBase
  ...
  class_option :include_stimulus, type: :boolean, default: false
  ...
  def create_stimulus_file
    return unless options[:include_stimulus]

    template "controller.js", File.join("app/components", class_path, file_name, "controller.js")
  end
